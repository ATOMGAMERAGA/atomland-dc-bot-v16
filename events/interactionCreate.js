  ...
  run: async(client, interaction) => {
      ...
      readdirSync('./commands').forEach(f => {
        ...
        if(interaction.commandName.toLowerCase() === cmd.name.toLowerCase()) {
          ...
          const btn = createButton(interaction, {
            ...
            emoji: "<a:arp:1318968419940569159>",
          ...
          if(!rulesisread) {
            ...
            .setTitle("> <a:AUtilityPoint:1284009114699038833>・Kuralları kabul etmek için **Kabul Ediyorum.** butonuna tıklayın!\n> <:NicePng_mariopixelpng_1691779:1284008084297224223>・Ama bunu yapmadan önce bi linklere göz atmanı isterim! Belki güzel bişe bulun ;)")
            .setDescription("\n\n**🔗 Linkler**\n> <:dosya:1319730198341488690>・**Botun kullanım koşulları: [Tıkla](https://github.com/ATOMGAMERAGA/atomland-terms-of-services)**\n> <:new_member:1319328788202520608>・**Botun gizlilik politikası: [Tıkla](https://github.com/ATOMGAMERAGA/atomland-privacy-policy)**")
            .setColor('Blue')
    ...
    if(interaction.isButton()) {
      ...
      if(interaction.customId === idFind("rulesClick")) {
        ...
        .setTitle("> <a:AUtilityPoint:1284009114699038833>・Kuralları kabul ettiğin için teşekkürler artık botun tadını çıkarabilirsin!")
        .setColor('Blue')
    ...
    if(butonrol)
      ...
      if (interaction.customId === "moderasyon_"+interaction.user.id) {
        ...
        const embed = new EmbedBuilder()
        .setTitle("> <:utility:1319281943812243456> | ATOMLAND - Moderasyon Menüsü!")
        .addFields(
      ...
      if (interaction.customId == "ileri_"+interaction.user.id) {
        ...
        .setTitle("> <:utility:1319281943812243456> | ATOMLAND - Moderasyon 2 Menüsü!")
        .addFields(
      ...
      if (interaction.customId == "kayıt_"+interaction.user.id) {
        ...
        const embed = new EmbedBuilder()
        .setTitle("> <a:ZippyRiri_Utility:1284009110320320555> | ATOMLAND - Kayıt Menüsü!")
        .addFields(
      ...
      if (interaction.customId == "kullanıcı_"+interaction.user.id) {
        ...
        const embed = new EmbedBuilder()
        .setTitle("> <:new_member:1319328788202520608> | ATOMLAND - Kullanıcı Menüsü!")
        .addFields(
      ...
      if (interaction.customId == "sistemler_"+interaction.user.id) {
        ...
        .setDescription("\n\n**🔗 Linkler**\n> <:Bot:1319328570845429861>・**Botun davet linki: [Tıkla](https://discord.com/oauth2/authorize?client_id=1285893895804293226&permissions=8&response_type=code&redirect_uri=https%3A%2F%2Fdc.atomland.xyz&integration_type=0&scope=bot+openid)**\n> <a:redutility4:1284009023515136002>・**Botun destek sunucusu: [Tıkla](https://dc.atomland.xyz)**\n> <:new_member:1319328788202520608>・**Botun gizlilik politikası: [Tıkla](https://github.com/ATOMGAMERAGA/ATOMLAND-privacy-policy/)**")
        .setColor('Blue')
      ...
      if (interaction.customId == "korumasystem_"+interaction.user.id) {
        const embed = new Discord.EmbedBuilder()
        .setTitle("> <a:minecraft:1284008806757564427> | ATOMLAND - Koruma Menüsü!")
        .addFields(
      ...
      if (interaction.customId == "yardimticket_"+interaction.user.id) {
        ...
        const embed = new EmbedBuilder()
        .setTitle("> 🎟️ | ATOMLAND - Ticket Menüsü!")
        .addFields(
