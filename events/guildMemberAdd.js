      ...
      try {
        ...
        if(member.user.bot) {
            if(data) {
                ...
                .setTitle("<a:tik:1318968486671945840> | Bot Onaylandı!")
            ...
            channel.send({
                content: `<@${member.user.id}>`, embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription('• Merhaba atomland kullanıcısı, seni sunucumuza güvenle alabilmek için altta bulunan yazıyı butona tıklayarak yazman gerekiyor.')
