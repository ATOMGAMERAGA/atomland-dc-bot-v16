...
module.exports =  {
  ...
  if (sebep) {
    ...
    .setDescription(`<:Discord_Pixel_Emoji:1288881557087453194> Etiketlediğin kullanıcı **${sebep}** sebebiyle afk modunda!`)
  ...
  message.delete()
  message.channel.send(`<a:arp:1318968419940569159> | Hey <@${message.author.id}>, Bu Sunucuda Küfür Engel Sistemi Aktif! `)
  }
  }
  ...
  if(linkler.some(alo => message.content.toLowerCase().includes(alo))) {
    ...
    if(message.author?.bot) return;
  message.delete()
  message.channel.send(`<a:arp:1318968419940569159> | Hey <@${message.author.id}>, Bu Sunucuda Reklam Engel Sistemi Aktif! `)
  }
  }
    ...
    if(message.channel.id == kanal){
      ...
      message.delete()
      const embed = new EmbedBuilder()
      .setTitle(`<a:AUtilityPoint:1284009114699038833> **UYARI!**`)
