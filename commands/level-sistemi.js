    ...
    switch(levelSystemTrue) {
      case "ac": {
        ...
        if (levelSystem && levelSystemDate) {
            ...
            .setDescription(`<a:arp:1318968419940569159> | Bu sistem <t:${parseInt(levelSystemDate.date / 1000)}:R> önce açılmış!`)
      ...
      case "kapat": {
        if(!levelSystem) return interaction.reply({ content: "<a:arp:1318968419940569159> | Bu sistem zaten kapalı?" });
