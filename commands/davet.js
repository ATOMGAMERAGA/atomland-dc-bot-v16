...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    const dvt = new Discord.ButtonBuilder().setLabel('Davet Linkim').setStyle('Link').setEmoji('1284008408382701590').setURL('https://discord.com/oauth2/authorize?client_id=1285893895804293226&scope=bot&permissions=27649375294');
