  ...
  run: async (client, interaction) => {
    if (
      ...
      return interaction.reply({
        content: "<a:arp:1318968419940569159> | İsimleri Yönet Yetkin Yok!",
        ephemeral: true,
      });
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields({
        name: "Evet Oy ver",
        value: `> Evet oyu vermek için **Evet** butonuna tıklayın.`,
        inline: false,
      })
      .addFields({
        name: "Hayır Oy ver",
        value: `> Hayır oyu vermek için **Hayır** butonuna tıklayın.`,
        inline: false,
      })
      .setColor("Random");
