...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const sunucuSahibi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<a:arp:1318968419940569159> | Sunucu sahibini susturamazsın dostum.")

        const kendiniSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<a:arp:1318968419940569159> | Kendine neden timeout atmak istersin ki?")

        const botuSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<a:arp:1318968419940569159> | Ben bir botum, beni susturup ne yapacaksın?")

        const gecerliSure = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<a:arp:1318968419940569159> | Susturabilmem için geçerli bir süre girmelisin.")
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Yellow")
            .setTitle("<a:tik:1318968486671945840> | Bir Üye Susturuldu!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<a:tik:1318968486671945840> | ${kullanıcı} adlı kullanıcıya **${süre}** süre boyunca timeout atıldı!`)
