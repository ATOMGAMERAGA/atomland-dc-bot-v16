...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (!interaction.member.roles.cache.has(db.fetch(`yetkili_${interaction.guild.id}`))) return interaction.reply(`<a:arp:1318968419940569159> | Bu komutu sadece ayarlanan **Mute Yetkilisi** rolü olan kişiler kullanabilir.`)
